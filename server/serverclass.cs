...
namespace server
{
    internal class serverclass
    {
        ...
        Dictionary<int, RoomClass> rooms = new Dictionary<int, RoomClass>(); // Room dictionary
            ...
            while ((msg = reader.ReadString()).Length > 0)
            {
                ...
                switch (ClientMsg[0])
                {
                    ...
                    case "2":
                        ...
                        if (messageFromPlayer1 == "notAccepted")
                        {
                    ...
                    case "10":
                        ...
                        break;
                    case "11"://i wanna switch betwean players
...
;                        int roomNumber = int.Parse(ClientMsg[2]);
                    ...
                    default:
                       // MessageBox.Show("Message from the inside of Switch default statement");
                        break;          
        ...
        {
            if (StateOfTheSender == "Host")//HostSendCorrectCharToPLyer2
            {
            ...
            if (StateOfTheSender == "Player")//Player2SendCorrectCharToHost
            {
        ...
        public void SayTheResult(int roomid )
        {
            ...
            string filePath = @"E:\projects\Project 21 FINAL\Scores.txt";

            using (StreamWriter writer3 = new StreamWriter(filePath))
            {
                writer3.WriteLine($"Player 1 name is {rooms[roomid].Player1Name} and the value is {rooms[roomid].Player1Score}");
                writer3.WriteLine($"Player 2 name is {rooms[roomid].Player2Name} and the value is {rooms[roomid].Player2Score}");
            }
